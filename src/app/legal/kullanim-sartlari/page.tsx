      ...
      <section className="space-y-8">
        <div className="space-y-4">
          ...
          <p className="text-slate-600 leading-relaxed">
            BiCalendo ("Platform") web sitesine erişerek veya hizmetlerini kullanarak, bu Kullanım Şartları'nı, Gizlilik Politikamızı ve ilgili tüm yasal düzenlemeleri kabul etmiş sayılırsınız. Şartları kabul etmiyorsanız, lütfen hizmetleri kullanmayınız.
          </p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <p className="text-slate-600 leading-relaxed">
            BiCalendo, sağlık profesyonellerine ve kliniklere yönelik bir randevu takip, hasta kayıt ve klinik yönetim yazılımıdır. Platform "Olduğu Gibi" (As-Is) esasıyla sunulmaktadır.
          </p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <p className="text-slate-600 leading-relaxed">
            BiCalendo, seçilen pakete göre aylık veya yıllık abonelik modeliyle çalışır. 
          </p>
          <ul className="list-disc pl-6 space-y-2 text-slate-600">
        ...
        <div className="space-y-4">
          ...
          <p className="text-slate-600 leading-relaxed">
            Platformun tasarımı, yazılım kodları, logoları ve tüm içerikleri BiCalendo'ya aittir ve telif hakları ile korunmaktadır. Önceden yazılı izin alınmaksızın kopyalanamaz veya dağıtılamaz.
          </p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <p className="text-slate-600 leading-relaxed">
            Teknik bakım veya beklenmedik sunucu sorunları nedeniyle oluşabilecek kısa süreli kesintilerden BiCalendo sorumlu tutulamaz. Veri kaybını önlemek için sistemimiz düzenli yedekleme yapmaktadır ancak kullanıcıların da kendi verilerini arşivlemesi önerilir.
          </p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <p className="text-slate-600 leading-relaxed">
            BiCalendo, bu şartları dilediği zaman güncelleme hakkını saklı tutar. Değişiklikler platform üzerinde yayınlandığı andan itibaren geçerlilik kazanır.
          </p>
        </div>
      </section>
    </article>
