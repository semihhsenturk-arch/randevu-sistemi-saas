      ...
      {isFullscreen && (
        <div className="absolute top-3 left-2 right-2 z-[100] flex justify-between items-start pointer-events-none">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-2 rounded-lg text-xs font-semibold border transition-all shadow-md bg-white/80 hover:bg-white border-slate-200/70 text-slate-700 pointer-events-auto backdrop-blur-sm"
          >
